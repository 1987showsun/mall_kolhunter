            ...
            <React.Fragment>
                <form onSubmit={this.handleSubmit.bind(this)} className="login-form">
                        ...
                        <li>
                            <label htmlFor="username">
                                <div className="input-box">
                                    <input type="email" name="username" id="username" value={ form['username'] } onChange={this.handleChange.bind(this)} placeholder="E-mail 會員帳號"/>
                                </div>
                            </label>
                        </li>
                        <li>
                    ...
                    <div className="form-row" data-direction="column">
                        ...
                        <Link to="/login/user/signup" className="signup_link">立即註冊</Link>
                    </div>
                </form>
            </React.Fragment>
        );
