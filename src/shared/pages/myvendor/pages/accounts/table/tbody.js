...
export default ({handleShowOrderDetail ,orderID, orderName, vendorFeeSub, vendorFeeTotal, orderDetail, orderStatus, orderStatusText, orderTimeMs, amount, totalVendorFeeSplit, vendorFee ,transactionFee, type}) => {
    return(
        <>
